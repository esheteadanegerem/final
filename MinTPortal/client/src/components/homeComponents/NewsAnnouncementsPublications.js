...
const NewsAnnouncementsPublications = () => {
  ...
  useEffect(() => {
    // Fetch news
    axios
      .get('https://final-0t4v.onrender.com/news')
      .then((response) => {
    ...
    // Fetch announcements
    axios
      .get('https://final-0t4v.onrender.com/resources/announcements')
      .then((response) => {
    ...
    // Fetch publications
    axios
      .get('https://final-0t4v.onrender.com/resources/publications')
      .then((response) => {
        const parsedData = typeof response.data === 'string' ? JSON.parse(response.data) : response.data;
